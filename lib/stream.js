...
var AC, FD, defaultCacheOptions, fs, mime, path, zlib, _;
...
module.exports = function(cacheOptions) {
  ...
  return function(req, res, next) {
    var defaultFailureFunction, defaultSuccessFunction;
    ...
    res.stream = function(src, streamOptions) {
      ...
      return cache.stat.get(src, function(err, stat) {
        var modified, _base, _base1, _base2;
        ...
        (_base = streamOptions.headers)['Last-Modified'] || (_base['Last-Modified'] = modified);
        (_base1 = streamOptions.headers)['Content-Type'] || (_base1['Content-Type'] = mime.lookup(src));
        (_base2 = streamOptions.headers)['ETag'] || (_base2['ETag'] = "\"" + stat.dev + "-" + stat.ino + "-" + (stat.mtime.getTime()) + "\"");
        return cache.fd.get(src, function(err, fd) {
          var checkIn, end, ini, n, readStream, total, _base3, _base4, _base5, _ref, _ref1;
          ...
          if (!req.headers.range) {
            ...
            (_base3 = streamOptions.headers)['Connection'] || (_base3['Connection'] = 'close');
            (_base4 = streamOptions.headers)['Cache-Control'] || (_base4['Cache-Control'] = 'public');
            ...
            (_base5 = streamOptions.headers)['Transfer-Encoding'] || (_base5['Transfer-Encoding'] = 'chunked');
